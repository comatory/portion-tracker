...
const REGISTER_IDS = 'REGISTER_IDS'
...
const ACTIVITY_IDS_UPDATE_ACTIVITY_PORTION = 'ACTIVITY_IDS_UPDATE_ACTIVITY_PORTION'
const ACTIVITY_IDS_DELETE_ACTIVITY_PORTIONS = 'ACTIVITY_IDS_DELETE_ACTIVITY_PORTIONS'
...
const REGISTER_IDS_REGISTER = 'REGISTER_IDS_REGISTER'
const REGISTER_IDS_VERIFY_USER_EMAIL = 'REGISTER_IDS_VERIFY_USER_EMAIL'
...
const REGISTER_IDS_REQUESTS = {
  REGISTER_IDS_REGISTER,
  REGISTER_IDS_VERIFY_USER_EMAIL,
}
...
const ACTIVITY_IDS_REQUESTS = {
  ...
  ACTIVITY_IDS_UPDATE_ACTIVITY_PORTION,
  ACTIVITY_IDS_DELETE_ACTIVITY_PORTIONS,
}
...
const API_IDS = {
  ...
  [REGISTER_IDS]: REGISTER_IDS_REQUESTS,
}
